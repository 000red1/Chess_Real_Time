...
public class ChessModel implements ActionListener{
  ...
  public void move(int intX, int intY){
    ...
    else if((highlightArray[intX][intY] == 1 || highlightArray[intX][intY] == 2)&&pieceArray[intX1Selected][intY1Selected].strColour.equals("WHITE")){
      //1. Moves the piece
  ...
  /**
   * Scans the entire board for a captured king, a pawn promoted to a queen, and other miscellaneous tasks after a piece has moved.
   */
