      ...
      for(int intRow = 0; intRow < 8; intRow++){
        for(int intColumn = 0; intColumn < 8; intColumn++){
          ...
          while(pieceArray[intRow][intColumn] != null){
            ...
            int intCooldown = pieceArray[intRow][intColumn].intCount;
            int intMaxCooldown = pieceArray[intRow][intColumn].intMaxCount;
            ...
            if(intCooldown > 0){
              ...
              g.fillRect(intRow*90 + 8, intColumn*90 + 8, 74, 8);
              g.setColor(cooldownFG);
              g.fillRect(intRow*90 + 8, intColumn*90 + 8, intCooldownMeter, 8);
            }
