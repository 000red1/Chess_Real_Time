...
public class Controller implements MouseListener, MouseMotionListener, ActionListener, KeyListener{
  ...
  JLabel skin = new JLabel("Choose a Skin");
  JLabel chat = new JLabel("Choose the QuickChat messages");
  JButton skin1 = new JButton("1");
  JButton skin2 = new JButton("2");
  JButton skin3 = new JButton("3");
  JButton chat1 = new JButton("1");
  JButton chat2 = new JButton("2");
  JButton chat3 = new JButton("3");
  JButton back = new JButton("Back");
  
  JTextField ipField = new JTextField("Enter the IP Address you wish to connect to");
  ...
  String strColour;
  String strSkin= "Samoht";
  String strChat= "QuickChat";
  ...
  public void actionPerformed(ActionEvent evt){
    if(evt.getSource()==back){
      ...
      skin1.removeActionListener(this);
      skin2.setVisible(false);
      skin2.removeActionListener(this);
      skin3.setVisible(false);
      skin3.removeActionListener(this);
      chat1.setVisible(false);
      chat1.removeActionListener(this);
      chat2.setVisible(false);
      chat2.removeActionListener(this);
      chat3.setVisible(false);
      chat3.removeActionListener(this);
      back.setVisible(false);
      back.removeActionListener(this);
      skin1.setBorderPainted(false);
      skin2.setBorderPainted(false);
      skin3.setBorderPainted(false);
      chat1.setBorderPainted(false);
      chat2.setBorderPainted(false);
      chat3.setBorderPainted(false);
      addText();
      setMenuVisible(false);
    }
    if(evt.getSource()==skin1){
      skin1.setBorderPainted(true);
      skin2.setBorderPainted(false);
      skin3.setBorderPainted(false);
      strSkin="Samoht";
    }
    if(evt.getSource()==skin2){
      skin1.setBorderPainted(false);
      skin2.setBorderPainted(true);
      skin3.setBorderPainted(false);
      strSkin="Nhoj";
    }
    if(evt.getSource()==skin3){
      skin1.setBorderPainted(false);
      skin2.setBorderPainted(false);
      skin3.setBorderPainted(true);
      strSkin="Bokaj";
    }
    if(evt.getSource()==chat1){
      chat1.setBorderPainted(true);
      chat2.setBorderPainted(false);
      chat3.setBorderPainted(false);
      strChat="QuickChat";
    }
    if(evt.getSource()==chat2){
      chat1.setBorderPainted(false);
      chat2.setBorderPainted(true);
      chat3.setBorderPainted(false);
      strChat="QuickChat2";
    }
    if(evt.getSource()==chat3){
      chat1.setBorderPainted(false);
      chat2.setBorderPainted(false);
      chat3.setBorderPainted(true);
      strChat="QuickChat3";
    }
    if(evt.getSource()==settingsButton){
      ...
      if(strSkin.equals("Samoht")){
        skin1.setBorderPainted(true);
      }
      if(strSkin.equals("Nhoj")){
        skin2.setBorderPainted(true);
      }
      if(strSkin.equals("Bokaj")){
        skin3.setBorderPainted(true);
      }
      if(strChat.equals("QuickChat")){
        chat1.setBorderPainted(true);
      }
      if(strChat.equals("QuickChat2")){
        chat2.setBorderPainted(true);
      }
      if(strChat.equals("QuickChat3")){
        chat3.setBorderPainted(true);
      }
    ...
    if(evt.getSource() == time){
      if(model.blnGame == true && panel.blnGame == false){
        ...
        panel.blnGame = true;
        strChat=strChat+".txt";
        model.loadGame(strColour,strChat);
        panel.loadSkin(strSkin); //Temporary
  ...
  public void addText(){
    serverButton.setText("Play as Server");
    serverButton.addActionListener(this);
    clientButton.setText("Play as Client");
  ...
  public Controller(){
    ...
    skin.setSize(1280,200);
    skin.setLocation(0,0);
    skin.setFont(new Font(Font.DIALOG, Font.BOLD, 60));
    skin.setOpaque(true);
    skin.setVisible(false);
    panel.add(skin);
    
    chat.setSize(1280,200);
    chat.setLocation(0,400);
    chat.setFont(new Font(Font.DIALOG, Font.BOLD, 60));
    chat.setOpaque(true);
    chat.setVisible(false);
    panel.add(chat);
    
    skin1.setSize(200,80);
    skin1.setLocation(200,300);
    skin1.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
    ...
    skin2.setSize(200,80);
    skin2.setLocation(600,300);
    skin2.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
    ...
    skin3.setSize(200,80);
    skin3.setLocation(1000,300);
    skin3.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
    ...
    chat1.setSize(200,80);
    chat1.setLocation(200,600);
    chat1.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
    chat1.setOpaque(false);
    chat1.setContentAreaFilled(false);
    chat1.setBorderPainted(false);
    chat1.setVisible(false);
    panel.add(chat1);
    
    chat2.setSize(200,80);
    chat2.setLocation(600,600);
    chat2.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
    chat2.setOpaque(false);
    chat2.setContentAreaFilled(false);
    chat2.setBorderPainted(false);
    chat2.setVisible(false);
    panel.add(chat2);
    
    chat3.setSize(200,80);
    chat3.setLocation(1000,600);
    chat3.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
    chat3.setOpaque(false);
    chat3.setContentAreaFilled(false);
    chat3.setBorderPainted(false);
    chat3.setVisible(false);
    panel.add(chat3);
    
    back.setSize(100,40);
    back.setLocation(0,680);
    ...
    ipField.setSize(230, 80);
    ipField.setLocation(320, 580);
    ipField.setFont(new Font(Font.DIALOG, Font.BOLD, 24));
